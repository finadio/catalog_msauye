    ...
    public function run(): void
    {
        ...
        $articles = [
            [
                ...
                'slug' => 'strategi-digital-marketing-efektif-untuk-umkm',
                ...
                'type' => 'edukasi',
                'photo' => 'https://loremflickr.com/640/480/digital,marketing',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'title' => 'BPR MSA Berhasil Salurkan Kredit UMKM Terbesar Tahun Ini',
                'slug' => 'bpr-msa-berhasil-salurkan-kredit-umkm-terbesar-tahun-ini',
                ...
                'type' => 'berita',
                'photo' => 'https://loremflickr.com/640/480/news,bank',
                'created_at' => now()->subDays(5),
                'updated_at' => now()->subDays(5),
            ],
            [
                'title' => 'Pentingnya Pencatatan Keuangan Sederhana bagi UMKM',
                'slug' => 'pentingnya-pencatatan-keuangan-sederhana-bagi-umkm',
                ...
                'type' => 'edukasi',
                'photo' => 'https://loremflickr.com/640/480/finance,accounting',
                'created_at' => now()->subDays(10),
                'updated_at' => now()->subDays(10),
            ],
            [
                'title' => 'Kolaborasi BPR MSA dengan Komunitas Pengrajin Lokal',
                'slug' => 'kolaborasi-bpr-msa-dengan-komunitas-pengrajin-lokal',
                ...
                'type' => 'berita',
                'photo' => 'https://loremflickr.com/640/480/collaboration,team',
                'created_at' => now()->subDays(15),
                'updated_at' => now()->subDays(15),
            ],
            [
                'title' => 'Tips Memilih Platform E-commerce Terbaik untuk UMKM',
                'slug' => 'tips-memilih-platform-e-commerce-terbaik-untuk-umkm',
                ...
                'type' => 'edukasi',
                'photo' => 'https://loremflickr.com/640/480/ecommerce,shopping',
                'created_at' => now()->subDays(3),
                'updated_at' => now()->subDays(3),
            ],
            [
                'title' => 'UMKM Makanan Lokal Berhasil Tembus Pasar Internasional Berkat Pembinaan BPR MSA',
                'slug' => 'umkm-makanan-lokal-berhasil-tembus-pasar-internasional-berkat-pembinaan-bpr-msa',
                ...
                'type' => 'berita',
                'photo' => 'https://loremflickr.com/640/480/food,export',
                'created_at' => now()->subDays(7),
                'updated_at' => now()->subDays(7),
            ],
            [
                'title' => 'Memaksimalkan Penggunaan Media Sosial untuk Promosi Produk',
                'slug' => 'memaksimalkan-penggunaan-media-sosial-untuk-promosi-produk',
                ...
                'type' => 'edukasi',
                'photo' => 'https://loremflickr.com/640/480/social,media',
                'created_at' => now()->subDays(20),
                'updated_at' => now()->subDays(20),
            ],
            [
                'title' => 'Dukungan BPR MSA Terhadap Digitalisasi UMKM di Masa Pandemi',
                'slug' => 'dukungan-bpr-msa-terhadap-digitalisasi-umkm-di-masa-pandemi',
                ...
                'type' => 'berita',
                'photo' => 'https://loremflickr.com/640/480/support,business',
                'created_at' => now()->subDays(22),
                'updated_at' => now()->subDays(22),
            ],
            // Tambahan artikel dummy
            [
                'title' => 'Inspirasi Usaha UMKM Sukses di Era Digital',
                'slug' => 'inspirasi-usaha-umkm-sukses-di-era-digital',
                'content' => 'Kisah sukses UMKM yang memanfaatkan teknologi digital untuk memperluas pasar dan meningkatkan omzet.',
                'type' => 'edukasi',
                'photo' => 'https://loremflickr.com/640/480/technology,business',
                'created_at' => now()->subDays(1),
                'updated_at' => now()->subDays(1),
            ],
            [
                'title' => 'Berita UMKM: Ekspor Kerajinan Lokal Meningkat',
                'slug' => 'berita-umkm-ekspor-kerajinan-lokal-meningkat',
                'content' => 'Ekspor produk kerajinan lokal dari UMKM Indonesia meningkat berkat dukungan pemerintah dan komunitas.',
                'type' => 'berita',
                'photo' => 'https://loremflickr.com/640/480/shipping,craft',
