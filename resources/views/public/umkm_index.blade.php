    ...
    <div class="relative bg-[#0B1120] pt-52 pb-24 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
            ...
            <p class="text-lg text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed">
                Temukan berbagai produk dan jasa berkualitas dari mitra UMKM terbaik yang telah kami kurasi untuk kebutuhan Anda.
            </p>
        </div>
    </div>
>>>>>>> Stashed changes
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8 border border-gray-100">
            <form method="GET" action="{{ route('public.umkm_index') }}" class="flex flex-col md:flex-row gap-4">
                ...
                @if(request('q') || request('kategori'))
                    <a href="{{ route('public.umkm_index') }}" class="md:w-auto px-6 py-3.5 bg-gray-100 hover:bg-gray-200 text-gray-600 font-medium rounded-xl transition-all duration-300 flex items-center justify-center" title="Reset Filter">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 flex flex-col h-full transform hover:-translate-y-1">
                        ...
                        <div class="relative h-56 overflow-hidden bg-gray-100">
                            ...
                            <div class="absolute bottom-0 left-0 right-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300 z-30">
                                <a href="{{ route('public.umkm_detail', $umkm->id) }}" class="block w-full py-2 bg-white/90 backdrop-blur-sm text-gray-900 text-sm font-semibold text-center rounded-lg hover:bg-white transition-colors">
                                    Lihat Detail
                                </a>
                            </div>
                        </div>
                ...
                @empty
                    <div class="col-span-full flex flex-col items-center justify-center py-16 text-center bg-white rounded-2xl border border-gray-100 shadow-sm">
                        ...
                        <a href="{{ route('public.umkm_index') }}" class="px-6 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors font-medium shadow-lg shadow-blue-500/30">
                            Reset Pencarian
                        </a>
                    </div>
                @endforelse
