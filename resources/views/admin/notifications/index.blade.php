                ...
                <div class="p-6 border-b border-gray-200">
                    <form method="GET" action="{{ route('admin.notifications.index') }}" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <select name="type" id="type" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                    ...
                                    <option value="NewUserRegistered" {{ request('type') === 'NewUserRegistered' ? 'selected' : '' }}>Pendaftaran UMKM</option>
                                    <option value="NewProductSubmitted" {{ request('type') === 'NewProductSubmitted' ? 'selected' : '' }}>Produk Baru</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="flex space-x-2">
                            ...
                            <a href="{{ route('admin.notifications.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded text-sm">
                                ...
                                <div class="border rounded-lg p-4 {{ $notification->read_at ? 'bg-gray-50' : 'bg-blue-50 border-blue-200' }}">
                                    <div class="flex items-start justify-between">
                                        ...
                                        <div class="flex space-x-2 ml-4">
                                            ...
                                            @endif
                                            <form method="POST" action="{{ route('admin.notifications.destroy', $notification->id) }}" class="inline">
                                                @csrf
                                                @method('DELETE')
