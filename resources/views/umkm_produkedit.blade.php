                    ...
                    <div class="bg-gradient-to-r from-emerald-50/50 to-blue-50/50 rounded-2xl p-8 border border-emerald-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="whatsapp" value="{{ $product->umkm->whatsapp ?? '' }}" 
                            ...
                            <div>
                                ...
                                <input type="text" name="instagram" value="{{ $product->umkm->instagram ?? '' }}" 
                            ...
                            <div>
                                ...
                                <input type="text" name="tiktok" value="{{ $product->umkm->tiktok ?? '' }}" 
                            ...
                            <div>
                                ...
                                <input type="url" name="website" value="{{ $product->umkm->website ?? '' }}" 
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="telepon" value="{{ $product->umkm->phone ?? '' }}" 
