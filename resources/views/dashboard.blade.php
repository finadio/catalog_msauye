<x-app-layout>
    ...
    <section class="bg-gradient-to-r from-blue-100 via-blue-50 to-white py-10 border-b mb-8">
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 px-4">
            <div class="flex-1">
                <h3 class="text-3xl md:text-4xl font-bold mb-2 text-blue-900">Selamat Datang di Dashboard PT BPR MSA</h3>
                <p class="mb-4 text-gray-700 text-lg">Pantau data UMKM, produk, artikel, dan kelola platform katalog UMKM dengan mudah dan profesional.</p>
